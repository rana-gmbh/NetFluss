...
- **Network layer = bundled Go `defguard-agent`** (grpc-swift 2 needs macOS 15;
  we keep macOS 13). Accept a Go build dependency + a new universal/signed/
  notarized bundled binary.
